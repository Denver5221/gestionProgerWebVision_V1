<x-base-layout :scrollspy="false">
    ...
    <div class="page-meta">
        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item active"><a href="{{getRouterValue();}}/user/list/">Liste d'utilisateurs</a></li>
                
                <li class="breadcrumb-item active" aria-current="page"><b>Profil</b></li>
            </ol>
        </nav>
    </div>
    <!-- /BREADCRUMB -->
            ...
            <div class="user-profile">
                <div class="widget-content widget-content-area">
                    ...
                    <div class="text-center user-info">
                        ...
                        <p class="">{{ $user->nom }} {{ $user->prenom }}</p>
                    </div>
                        ...
                        <div class="">
                            <ul class="contacts-block list-unstyled">
                                <li class="contacts-block__item">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-coffee me-3"><path d="M18 8h1a4 4 0 0 1 0 8h-1"></path><path d="M2 8h16v9a4 4 0 0 1-4 4H6a4 4 0 0 1-4-4V8z"></path><line x1="6" y1="1" x2="6" y2="4"></line><line x1="10" y1="1" x2="10" y2="4"></line><line x1="14" y1="1" x2="14" y2="4"></line></svg> {{ $user->poste->nom }}

                                </li>
                                <li class="contacts-block__item">
                                    <i class="las la-info-circle" style="font-size: 25px;"></i>

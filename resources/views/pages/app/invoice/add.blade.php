    ...
    <div class="page-meta">
        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><b>Ajout Facture Définitive</b></li>
            </ol>
        </nav>
    </div>
    <!-- /BREADCRUMB -->
    <form action="{{ route('facture_def.store') }}" method="POST">
        @csrf
                                            ...
                                            <div class="row justify-content-around">
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <input type="text" class="form-control form-control-sm" id="number" placeholder="082/07/2023/WV" name="NumeroFacture" required>
                                                    </div>
                                                    <div class="form-group ">
                                                        <label for="due">Date d'échéance <span style="color:red;">*</span> </label>
                                                        <input type="text" class="form-control form-control-sm" id="due" placeholder="None" name="date_echeant" required>
                                                    </div>
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <input type="text" class="form-control form-control-sm" id="date" placeholder="Add date picker" name="date" required>
                                                    </div>
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <input type="text" class="form-control form-control-sm" id="date" placeholder="Add date picker" name="taxe" required>
                                                    </div>
                                                    <div class="form-group ">
                                                        <label for="date"> Poucentage Taxe <span style="color:red;">*</span> </label>
                                                        <input type="text" class="form-control form-control-sm" id="date" placeholder="Add date picker" name="pourcentage" required>
                                                    </div>
                                        ...
                                        <div class="row justify-content-between">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="mb-4 form-group">
                                                    ...
                                                    <input type="text" class="form-control form-control-sm" id="name" placeholder="Nom" name="nom_client" required>
                                                </div>
                                                <div class="mb-4 form-group">
                                                    <label for="name"> N° RCCM </label>
                                                    <input type="number" class="form-control form-control-sm" id="name" placeholder="RCCM" name="rccm">
                                                </div>
                                                <div class="mb-4 form-group">
                                                    <label for="name"> N° IFU </label>
                                                    <input type="number" class="form-control form-control-sm" id="name" placeholder="IFU" name="ifu">
                                                </div>
                                                <div class="mb-4 form-group">
                                                    <label for="name"> Addresse </label>
                                                    <input type="text" class="form-control form-control-sm" id="name" placeholder="Addresse" name="addresse">
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control form-control-sm" id="objet" placeholder="Objet" name="Objet" required>
                                                </div>
                                                <br>
                                                <div class="mb-4 form-group">
                                                    <label for="name"> Telephone </label>
                                                    <input type="tel" class="form-control form-control-sm" id="name" placeholder="Tel..." name="telephone">
                                                </div>
                                            </div>
                                                ...
                                                <tbody id="table-body">
                                                    <tr>
                                                        ...
                                                        <td class="description">
                                                            <input type="text" class="form-control form-control-sm" placeholder="Désignation item" name="designation[]">
                                                            <textarea class="form-control" placeholder="Autres détails" name="details[]"></textarea>
                                                        </td>
                                                        <td class="rate">
                                                            <input type="number" class="form-control form-control-sm" placeholder="Prix" name="prix_unitaire[]" oninput="calculerTotal(this)">
                                                        </td>
                                                        <td class="text-right qty">
                                                            <input type="number" class="form-control form-control-sm" placeholder="Quantité" name="quantite[]" oninput="calculerTotal(this)">
                                                        </td>
                                                        <td class="text-right amount">
                                                            <span class="editable-amount">
                                                                <span class="amount">0</span>
                                                                <input type="hidden" name="total[]" value="0"> <!-- Champ pour le total -->
                                                            </span>
                                                        </td>
                                                    </tr>
                                                </tbody>

<x-base-layout :scrollspy="false">
    ...
    <!-- /BREADCRUMB -->
    <form action="{{ route('facture_proforma.store') }}" method="POST">
        @csrf
                                            ...
                                            <div class="row justify-content-around">
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <input type="text" class="form-control form-control-sm" id="tax" placeholder="Add name tax" name="taxe" required>
                                                    </div>
                                                    <div class="form-group ">
                                                        <label for="date"> Poucentage Taxe <span style="color:red;">*</span> </label>
                                                        <input type="text" class="form-control form-control-sm" id="tax" placeholder="Add percent tax" name="pourcentage" required>
                                                    </div>

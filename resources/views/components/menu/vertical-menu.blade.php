        ...
        <div class="sidebar-wrapper sidebar-theme">
            ...
            <nav id="sidebar">
                ...
                <div class="navbar-nav theme-brand flex-row  text-center">
                    <div class="nav-logo">
                        ...
                        <div class="nav-item theme-text">
                            <a href="{{getRouterValue();}}/dashboard/analytics" class="nav-link"> GESTION </a>
                        </div>
                    </div>
                    ...
                    <div class="profile-info">
                        <div class="user-info">
                            <div class="profile-img">
                                @php
                                    $randomImage = 'profile-' . rand(1, 34) . '.jpeg'; // Supposons que vous ayez des images nommées profile-1.png, profile-2.png, etc.
                                @endphp
                                <img src="{{ Vite::asset('resources/images/' . $randomImage) }}" alt="avatar">
                            </div>
                            <div class="profile-content">
                                <h6 class="">{{ Auth::user()->nom }} {{  Auth::user()->prenom }}</h6>
                                @php
                                    $userRole = App\Models\Role::find(Auth::user()->id_role);
                                @endphp
                                <p class="">{{ $userRole->nom ?? 'Role inconnu' }}</p>
                            </div>
                        </div>
                    </div>
                @endif
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu {{ Request::routeIs('projet.index') ? 'active' : '' }}">
                        <a href="{{getRouterValue();}}/app/projet" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu {{ Request::routeIs('expenses.index') ? 'active' : '' }}">
                        <a href="{{getRouterValue();}}/app/expenses" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu {{ Request::is('*/app/invoice/*') ? 'active' : '' }}">
                        <a href="{{getRouterValue();}}/app/invoice/list" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                    ...
                    <!-- <li class="menu {{ Request::is('*/app/invoice/*') ? "active" : "" }}">
                        ...
                        <ul class="collapse submenu list-unstyled {{ Request::is('*/app/invoice/*') ? "show" : "" }}" id="invoice" data-bs-parent="#accordionExample">
                            <li class="{{ Request::routeIs('invoice-list') ? 'active' : '' }}">
                                <a href="{{getRouterValue();}}/app/invoice/list"> Liste </a>
                            </li>
                    ...
                    <li class="menu {{ Request::is('*/user/*') ? "active" : "" }}">
                        ...
                        <ul class="collapse submenu list-unstyled {{ Request::is('*/user/*') ? "show" : "" }}" id="users" data-bs-parent="#accordionExample">
                            ...
                            <li class="{{ Request::routeIs('role') ? 'active' : '' }}">
                                <a href="{{getRouterValue();}}/user/role"> Rôles </a>
                            </li>
                            <li class="{{ Request::routeIs('poste') ? 'active' : '' }}">
                                <a href="{{getRouterValue();}}/user/post"> Postes </a>
                            </li>
                            <li class="{{ Request::routeIs('categorie') ? 'active' : '' }}">
                                <a href="{{getRouterValue();}}/user/categorie"> Catégories </a>
                            </li>
                        </ul>
                    </li>

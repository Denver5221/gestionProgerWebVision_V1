$(function() {
    ...
    */
    ...
    $(".add-list").off('click').on('click', function(event) {
        ...
        // var $_listDescription = document.getElementById('s-description').value;
        // var $_listDelai = document.getElementById('s-delai').value;
        // var $_listParticipant = document.getElementById('s-list-part').value;
        ...
        let $html = '<div data-section="s-'+$_listSectionDataAttr+'" class="task-list-container  mb-4 " data-connect="sorting">'+
                    '<div class="connect-sorting">'+
                        ...
                        //             '<div class="">'+
                        //                 '<h5>Description :</h5>'+
                        //                 '<p class="m-2" data-listDescription="'+$_listDescription+'">'+$_listDescription+'</p>'+
                        //             '</div>'+
                        //     '</div>'+
                        //     '<div class="task-header">'+
                        //             '<div class="">'+
                        //                 '<h5>Participants :</h5>'+
                        //                 '<p class="" data-listParticipant="'+$_listParticipant+'">- '+$_listParticipant+' '<br>+' </p>'+
                        //             '</div>'+
                        //     '</div>'+
                        //     '<div class="task-content">'+
                        //         '<div class="">'+
                        ...
                        //         '<div class="task-bottom">'+
                        //             '<div class="tb-section-1">'+
                        //                 '<span data-listDelai="'+$_listDelai+'"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-calendar"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg> '+$_listDelai+' </span>'+
                        //             '</div>'+
                        //             '<div class="tb-section-2">'+

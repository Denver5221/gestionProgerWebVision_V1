...
use App\Http\Controllers\EntreeSortieCategorieController;
use App\Http\Controllers\FactureDefinitiveController;
use App\Http\Controllers\FactureProformaController;
use App\Http\Controllers\FactureAncieneController;
use App\Http\Controllers\FactureAvanceController;
...
foreach ($prefixRouters as $prefixRouter) {
    Route::prefix($prefixRouter)->group(function () {
        ...
        Route::prefix('app')->group(function () {
            ...
            //Routes Gestion de Projets
            // Route::get('/index', function () {
            //     return view('pages.app.projet.index', ['title' => 'Projet | CORK - Multipurpose Bootstrap Dashboard Template', 'breadcrumb' => 'This Breadcrumb']);
            // })->name('projet');

            // Route::get('/projet', function () {
            //     return view('pages.app.projet.projet', ['title' => 'Projet | CORK - Multipurpose Bootstrap Dashboard Template', 'breadcrumb' => 'This Breadcrumb']);
            // })->name('projet');
            // Route::get('/projet/view', function () {
            //     return view('pages.app.projet.view_projet', ['title' => 'Projet | CORK - Multipurpose Bootstrap Dashboard Template', 'breadcrumb' => 'This Breadcrumb']);
            // })->name('projet');

            //Routes Gestion Entrées/Sorties
            ...
            Route::prefix('expenses')->group(function () {
                ...
                //Route::get('/{nom}/{id}', [EntreeSortieController::class, 'show'])->name('expenses.show');
                Route::get('/categorie/{categorie}', [EntreeSortieController::class, 'showSimple'])->name('expenses.show1');
                // Route::get('/{id}/edit', [EntreeSortieController::class, 'edit'])->name('expenses.edit');
                Route::put('/{entreeSortie}', [EntreeSortieController::class, 'update'])->name('expenses.update');
                Route::put('/{projets}', [VotreControleur::class, 'update1'])->name('expenses.update1');
                Route::delete('/{id}', [EntreeSortieController::class, 'destroy'])->name('expenses.destroy');
                Route::delete('/projet/{id}', [EntreeSortieController::class, 'Projetdestroy'])->name('projects.destroy');
                Route::delete('/{id}', [EntreeSortieController::class, 'Simpledestroy'])->name('categoriesexpenses.destroy');

                Route::get('/projet/{id}', [EntreeSortieController::class, 'show'])->name('expenses2.show2');
            });

            Route::prefix('categoriesexpenses')->group(function () {
                Route::get('/', [EntreeSortieCategorieController::class, 'index'])->name('categoriesexpenses.index');
                Route::get('/create', [EntreeSortieCategorieController::class, 'create'])->name('expenses.create');
                Route::post('/', [EntreeSortieCategorieController::class, 'store'])->name('categoriesexpenses.store');
                Route::get('/{id}', [EntreeSortieCategorieController::class, 'show'])->name('categoriesexpenses.show');
                Route::put('/{entreeSortie}', [EntreeSortieCategorieController::class, 'update'])->name('categoriesexpenses.update');
                Route::delete('/{id}', [EntreeSortieCategorieController::class, 'Categoriedestroy'])->name('categories.destroy');
            });

            Route::prefix('projet')->group(function () {
                Route::get('/', [ProjetController::class, 'index'])->name('projet.index');
                Route::get('/create', [ProjetController::class, 'create'])->name('expenses.create');
                Route::post('/', [ProjetController::class, 'store'])->name('projet.store');
                Route::get('/{categorie}', [ProjetController::class, 'show'])->name('projet.show');
                Route::get('/view/{projet}', [ProjetController::class, 'view'])->name('projet.view');
                Route::put('/{projet}', [ProjetController::class, 'update'])->name('projet.update');
                Route::delete('/{id}', [ProjetController::class, 'Categoriedestroy'])->name('categories.destroy');
                Route::post('/{projet}/addtache', [ProjetController::class, 'ajouterTache'])->name('projet.ajoutertache');
                Route::get('/{projet}/taches', [ProjetController::class, 'afficherTaches'])->name('projet.affichertache');
                Route::post('/{tache}/sous-tache', [ProjetController::class, 'ajouterSousTache'])->name('projet.ajouterSoustache');
                Route::delete('/{id}', [ProjetController::class, 'destroy'])->name('tache.destroy');
            });

            //Route::get('/entree-sortie-categories', [EntreeSortieCategorieController::class, 'index'])->name('entree_sortie_categories.index');

            // Route::get('/expenses', function () {
            //     return view('pages.app.expenses.expenses', ['title' => 'Chat Application | CORK - Multipurpose Bootstrap Dashboard Template', 'breadcrumb' => 'This Breadcrumb']);
            // })->name('chat');
            // Route::get('/expenses/view', function () {
            //     return view('pages.app.expenses.view_expenses', ['title' => 'Chat Application | CORK - Multipurpose Bootstrap Dashboard Template', 'breadcrumb' => 'This Breadcrumb']);
            // })->name('chat');
            // Route::get('/expenses/view.simple', function () {
            //     return view('pages.app.expenses.view_simpleExpenses', ['title' => 'Chat Application | CORK - Multipurpose Bootstrap Dashboard Template', 'breadcrumb' => 'This Breadcrumb']);
            // })->name('chat');
            ...
            Route::prefix('/invoice')->group(function () {
                ...
                Route::get('/add', [FactureDefinitiveController::class, 'index'])->name('invoice-add');
                Route::post('/add_definitive', [FactureDefinitiveController::class, 'store'])->name('facture_def.store');
                Route::get('/voire_def_facture/{id}', [FactureDefinitiveController::class, 'show'])->name('facture_def.show');
                Route::get('/edite_def_facture/{id}', [FactureDefinitiveController::class, 'edit'])->name('facture_def.edite');
                Route::put('update_def_facture/{id}', [FactureDefinitiveController::class, 'update'])->name('facture_def.update');
                Route::delete('/delete_def_facture/{id}', [FactureDefinitiveController::class, 'destroy'])->name('facture_def.destroy');

              
                
                Route::get('/list', [FactureDefinitiveController::class, 'list'])->name('invoice-list');
                
                    // Factures Proforma
                Route::get('/add_proforma', [FactureProformaController::class, 'index'])->name('invoice-add-proforma');    
                Route::post('/add_facture_proforma', [FactureProformaController::class, 'store'])->name('facture_proforma.store');
                Route::get('/edite_proforma/{id}', [FactureProformaController::class, 'edit'])->name('facture_proforma.edite');
                Route::put('update_proforma/{id}', [FactureProformaController::class, 'update'])->name('facture_proforma.update');
                Route::delete('/delete_facture_proforma/{id}', [FactureProformaController::class, 'destroy'])->name('facture_proforma.destroy');

                /////////// Facture anciene
                Route::post('/facture_anciene', [FactureAncieneController::class, 'store'])->name('facture_anciene.store');
                Route::put('/facture_anciene/{id}', [FactureAncieneController::class, 'update'])->name('facture_anciene.update');
                Route::delete('/facture_anciene_delete/{id}', [FactureAncieneController::class, 'destroy'])->name('facture_anciene.delete');
                
                // Factures avances
                Route::get('/avances/{id}', [FactureAvanceController::class, 'show'])->name('facture_avances.show');
                Route::post('/facture_avances/{id}', [FactureAvanceController::class, 'store'])->name('facture_avances.store');
                Route::get('/facture_avances_edite/{id}', [FactureAvanceController::class, 'edit'])->name('facture_avances.edite');

                // Route::get('/avances', function () {
                //     return view('pages.app.invoice.avance', ['title' => 'Invoice Preview | CORK - Multipurpose Bootstrap Dashboard Template ', 'breadcrumb' => 'This Breadcrumb']);
                // })->name('invoice-avances');
            });
        });
        ...
        Route::prefix('/forum')->group(function () {
            Route::get('/', function() {
                return view('pages.forum.forum', ['title' => 'Invoice Preview | CORK - Multipurpose Bootstrap Dashboard Template ', 'breadcrumb' => 'This Breadcrumb']);
            });
            Route::get('/utilisateurs', function() {
                return view('pages.forum.utilisateurs', ['title' => 'Invoice Preview | CORK - Multipurpose Bootstrap Dashboard Template ', 'breadcrumb' => 'This Breadcrumb']);
            });
            Route::get('/utilisateurs/information', function() {
                return view('pages.forum.voirtutilisateurs', ['title' => 'Invoice Preview | CORK - Multipurpose Bootstrap Dashboard Template ', 'breadcrumb' => 'This Breadcrumb']);
            });
            Route::get('/categories', function() {
                return view('pages.forum.categorie', ['title' => 'Invoice Preview | CORK - Multipurpose Bootstrap Dashboard Template ', 'breadcrumb' => 'This Breadcrumb']);
            });
        });
        ...
        Route::middleware(['auth', 'role:admin,editeur'])->group(function(){
            Route::prefix('user')->group(function () {
                Route::get('/list' , [CustomRegisterController::class, 'showUsersList'])->name('users');

                Route::get('/view/{user}', [CustomRegisterController::class, 'showUserProfile'])->name('user.profile');
                Route::get('/edit/{user}', [CustomRegisterController::class, 'edit'])->name('user.settings');
                Route::put('/{user}', [CustomRegisterController::class, 'update'])->name('user.update');


                // Route::get('/edit', function () {
                //     return view('pages.app.users.settings', ['title' => 'User Profile | CORK - Multipurpose Bootstrap Dashboard Template ', 'breadcrumb' => 'This Breadcrumb']);
                // })->name('users');

                Route::get('/categorie', function () {
                    return view('pages.app.users.categorie', ['title' => 'Chat Application | CORK - Multipurpose Bootstrap Dashboard Template', 'breadcrumb' => 'This Breadcrumb']);
                })->name('categorie');

...
class FactureAvanceController extends Controller
{
    /**
    ...
    public function show($id)
    {
        try{
            ...
            $facture = Facture::findOrFail($id);
             return view('pages.app.invoice.avance', ['facture' => $facture,'projets'=>$projets,'categorie'=>$categorie,'title' => 'Invoice Add | CORK - Multipurpose Bootstrap Dashboard Template ', 'breadcrumb' => 'This Breadcrumb']);
    ...
    public function edit($id)
    {
        try{
            ...
            $projets = Projet::all();
            $facture =Facture::findOrFail($id);
            return view('pages.app.invoice.edite_avance', ['projets'=>$projets,'categorie'=>$categorie,'facture'=>$facture,'title' => 'Invoice Edit | CORK - Multipurpose Bootstrap Dashboard Template ', 'breadcrumb' => 'This Breadcrumb']);

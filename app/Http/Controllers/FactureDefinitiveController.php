...
class FactureDefinitiveController extends Controller
{
    /**
    ...
    public function index()
    {
        try{
            ...
            $projets =Projet::all();
            return view('pages.app.invoice.add', ['projets'=>$projets,'categorie'=>$categorie,'title' => 'Invoice Add | CORK - Multipurpose Bootstrap Dashboard Template ', 'breadcrumb' => 'This Breadcrumb']);
    ...
    public function list()
    {
       try{
               ...
               return view('pages.app.invoice.list', ['categorie' =>$categorie,'facture'=>$facture,'title' => 'Invoice List | CORK - Multipurpose Bootstrap Dashboard Template ', 'breadcrumb' => 'This Breadcrumb']);
   ...
   // Créer le client s'il n'existe pas ou le récupérer s'il existe déjà
    ...
    public function show($id)
    {
        try{
            ...
            return view('pages.app.invoice.preview', ['facture'=>$facture ,'title' => 'Invoice Preview | CORK - Multipurpose Bootstrap Dashboard Template ', 'breadcrumb' => 'This Breadcrumb']);
    ...
    public function edit($id)
    {
        try{
            ...
            $projets = Projet::all();
            $facture =Facture::findOrFail($id);
            return view('pages.app.invoice.edit', ['projets'=>$projets,'categorie'=>$categorie,'facture'=>$facture,'title' => 'Invoice Edit | CORK - Multipurpose Bootstrap Dashboard Template ', 'breadcrumb' => 'This Breadcrumb']);
